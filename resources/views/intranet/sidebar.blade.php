<div>
    <!-- Desktop sidebar -->
    <aside class="z-20 hidden h-full overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0" style="width: 14rem;">
        <div class="py-4 text-gray-500 dark:text-gray-400">
            ...
            <ul class="mt-6">
                ...
                <x-button.responsive-nav-link href="{{ route('intranet') }}" :active="request()->routeIs('intranet')">
                ...
                <li class="relative px-6 py-3">
                    <x-button.responsive-nav-link href="{{ route('intranet.salons.index') }}" :active="request()->routeIs('intranet.salons.index')">
                        ...
                        <span class="ml-4">{{ __('Salones') }}</span>
                    </x-button.responsive-nav-link>
                </li>
                <li class="relative px-6 py-3">
                    <x-button.responsive-nav-link href="{{ route('intranet.services.index') }}" :active="request()->routeIs('intranet.services.index')">
                        <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                        </svg>
                ...
                <li class="relative px-6 py-3">
                    <x-button.responsive-nav-link href="{{ route('intranet.reservations.index') }}" :active="request()->routeIs('intranet.reservations.index')">
                        ...
                        <span class="ml-4">{{ __('Reservas') }}</span>
                    </x-button.responsive-nav-link>
                </li>
                <li class="relative px-6 py-3">
                    <x-button.responsive-nav-link href="#">
                        <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                        </svg>
